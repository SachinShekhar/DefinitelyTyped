...
function runTest() {
  StreamTest.versions.forEach((version) => {
    StreamTest[version].fromChunks(['hello']); // $ExpectType Readable<BufferOrString>
    StreamTest[version].fromChunks(['hello'], 10); // $ExpectType Readable<BufferOrString>

    StreamTest[version].fromObjects(fromObjectsTestArray); // $ExpectType Readable<BufferOrString>
    StreamTest[version].fromObjects(fromObjectsTestArray, 10); // $ExpectType Readable<BufferOrString>

    const errorChunkStream1 = StreamTest[version].fromErroredChunks(
      new Error('bad thing'),
      [Buffer.from('some data')],
    );
    errorChunkStream1; // $ExpectType Readable<BufferOrString>
    ...
    errorChunkStream2; // $ExpectType Readable<BufferOrString>
    ...
    errorObjectStream1; // $ExpectType Readable<BufferOrString>
    ...
    errorObjectStream2; // $ExpectType Readable<BufferOrString>
    ...
    toChunks; // $ExpectType Writable<BufferOrString>
    ...
    toObjects; // $ExpectType Writable<BufferOrString>
    ...
    toText; // $ExpectType Writable<BufferOrString>

    StreamTest[version].syncReadableChunks(); // $ExpectType PassThrough<BufferOrString, BufferOrString>

    StreamTest[version].syncReadableObjects(); // $ExpectType PassThrough<BufferOrString, BufferOrString>
